...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarColor02">  
    ...
    <?php 
    //add home if User is not logged in (Had to do it like this because home is simply the base url)
      ...
      <?php
          //Load  data from navigation model to Navbar
           $baseurl = base_url();
            ...
            {
              echo '<li class="nav-item"> <a class="nav-link" href='."$baseurl"."$element".">".rtrim($element,"s")."</a> </li>";
            }
      ?>
    </ul>
    </div>
